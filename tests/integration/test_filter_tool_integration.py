...
class TestFilterToolIntegration(unittest.IsolatedAsyncioTestCase):
    ...
    def setUp(self):
        ...
        self.test_issues = [
            Issue(
                ...
                issue_cwe="CWE-119",
                issue_cwe_link="https://cwe.mitre.org/data/definitions/119.html",
            ...
            Issue(
                ...
                issue_cwe="CWE-476",
                issue_cwe_link="https://cwe.mitre.org/data/definitions/476.html",
            ...
            Issue(
                ...
                issue_cwe="CWE-134",
                issue_cwe_link="https://cwe.mitre.org/data/definitions/134.html",
        ...
        self.tracker = TestUtils.create_clean_filter_tracker(
            issues=self.test_issues, config=self.mock_config
        )
    ...
    async def test_given_same_issues_when_both_methods_applied_then_same_known_false_positives_identified(  # noqa: E501
        self,
        mock_read_file,
        mock_create_retriever_run_script,
        mock_create_retriever_tool,
        mock_llm_service_tool,
    ):
        """Given the same issues, when both filter methods are applied, then the same known false positives are identified."""  # noqa: E501
        # preparation
        ...
        with (
            ...
            patch(
                "stage.filter_known_issues.convert_similar_issues_to_examples_context_string",
                side_effect=mock_convert_context,
            ),
        ):
        ...
        for issue_id, issue_data in filter_result.issues.items():
            if (
                ...
                and issue_data.analysis_response.is_final == FinalStatus.TRUE.value
                and issue_data.analysis_response.investigation_result
