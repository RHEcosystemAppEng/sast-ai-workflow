...
class Config:
    ...
    CONFIDENCE_WEIGHT_AGENT: float
    CONFIDENCE_WEIGHT_EVIDENCE: float
    CONFIDENCE_WEIGHT_INVESTIGATION: float
    EVIDENCE_WEIGHT_FAISS_SCORE: float
    EVIDENCE_WEIGHT_FILES_FETCHED: float
    EVIDENCE_WEIGHT_EVIDENCE_COUNT: float
    INVESTIGATION_WEIGHT_DEPTH: float
    INVESTIGATION_WEIGHT_TOOL_CALLS: float
    INVESTIGATION_WEIGHT_REANALYSIS: float
    INVESTIGATION_WEIGHT_STOP_REASON: float
    CONFIDENCE_MAX_FILES_FOR_NORMALIZATION: int
    CONFIDENCE_MAX_EVIDENCE_ITEMS_FOR_NORMALIZATION: int
    CONFIDENCE_MAX_SYMBOLS_FOR_NORMALIZATION: int
    CONFIDENCE_MAX_TOOL_CALLS_FOR_NORMALIZATION: int
    CONFIDENCE_MAX_REANALYSIS_FOR_NORMALIZATION: int
    STOP_REASON_SCORE_APPROVED: float
    STOP_REASON_SCORE_MAX_ITERATIONS: float
    STOP_REASON_SCORE_NO_PROGRESS: float
    STOP_REASON_SCORE_UNKNOWN: float
