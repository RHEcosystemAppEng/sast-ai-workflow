...
KNOWN_ISSUES_SHORT_JUSTIFICATION = (
    "The error is similar to one found in the provided "
...
WRITE_RESULTS_NO_VALID_METRICS = (
    "Calculate_Metrics node failed or was skipped - "
    "creating EvaluationSummary from scratch for Excel generation"
)
...
CONFIDENCE_WEIGHT_FILTER = 0.20
CONFIDENCE_WEIGHT_AGENT = 0.30
CONFIDENCE_WEIGHT_EVIDENCE = 0.20
CONFIDENCE_WEIGHT_INVESTIGATION = 0.30

# Evidence strength sub-component weights (must sum to 1.0)
EVIDENCE_WEIGHT_FAISS_SCORE = 0.40
EVIDENCE_WEIGHT_FILES_FETCHED = 0.30
EVIDENCE_WEIGHT_EVIDENCE_COUNT = 0.30

# Investigation confidence sub-component weights (must sum to 1.0)
...
# Normalization caps for evidence and investigation metrics
CONFIDENCE_MAX_FILES_FOR_NORMALIZATION = 10
CONFIDENCE_MAX_EVIDENCE_ITEMS_FOR_NORMALIZATION = 5
CONFIDENCE_MAX_SYMBOLS_FOR_NORMALIZATION = 5
CONFIDENCE_MAX_TOOL_CALLS_FOR_NORMALIZATION = 20
CONFIDENCE_MAX_REANALYSIS_FOR_NORMALIZATION = 3